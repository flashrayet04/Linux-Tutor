...
const RANKS = [
    ...
    { name: "Master SysAdmin", icon: "🛠️", minXP: 1800 },
...
const ACHIEVEMENTS = [
    ...
    { id: "grep_detective", title: "Grep Detective", desc: "Filter logs with grep.", icon: "🕵️", unlocked: false },
    ...
    { id: "time_traveler", title: "Time Traveler", desc: "Check your command history.", icon: "🕰️", unlocked: false }
];
